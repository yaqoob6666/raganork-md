...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || 'Y̶A̶Q̶O̶O̶B̶;Sk786;0;https://i.imgur.com/UVdVHjB.jpg;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHb',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "Y̶A̶Q̶O̶O̶B̶",
    BOT_NAME: process.env.BOT_NAME || 'Y̶A̶Q̶O̶O̶B̶',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ꪶ͢٭𝑺𝜣𝑼𝑹𝛢𝑽𝑲𝑳¹¹ꫂ;Y̶A̶Q̶O̶O̶B̶ MD bot;https://i.imgur.com/UVdVHjB.jpg' : process.env.AUDIO_DATA,
